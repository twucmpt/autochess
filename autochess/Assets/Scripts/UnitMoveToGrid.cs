...
public class UnitMoveToGrid : MonoBehaviour
{
    ...
    void Update()
    {
		...
		if (unit.animator.GetCurrentAnimatorStateInfo(0).IsName("walk")) transform.position = Vector3.MoveTowards(transform.position, gridToWorldPos, Time.deltaTime*movementSpeed);
    }
}
